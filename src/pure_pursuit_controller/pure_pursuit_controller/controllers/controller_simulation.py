...
class PurePursuit(Node):
    ...
    def publish_drive(self, angle):
        ...
        # =========================================================================
        # 💡 GIẢM TỐC KHI CUA GẤP (> 20 độ / 0.35 rad)
        # Bỏ comment 2 dòng dưới đây nếu bạn muốn xe tự động giảm tốc độ khi vào cua.
        # =========================================================================
        # if abs(angle) > 0.35: 
        #     speed *= 0.5 
            
        # =========================================================================
        # ⚠️ GIỚI HẠN GÓC LÁI XE THẬT (0.35 rad ~ 20 độ)
        # Đồng bộ hóa giới hạn vật lý của Simulation về bằng đúng với Xe Thật.
        # Bạn có thể thay đổi giá trị 0.35 này nếu muốn thử nghiệm góc lái lớn hơn.
        # =========================================================================
